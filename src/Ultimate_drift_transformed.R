...
model_ultdrift_reduced<- lm(log(T)~I+J+K+M+log(Q),data=dataset_2)
summary(model_ultdrift_reduced)

sink("C:/Users/J/Desktop/Course_DataAnalysis/results/result_model_ultdrift_reduced_transformed.txt")
...
theme_linedraw()+
  ...
  scale_x_continuous(breaks=c(-1,-0.5,0,0.5,1.0,1.5),limits=c(-1, 1.5),expand = c(0, 0.2))+
  scale_y_continuous(breaks=seq(-1.5,15,0.5),limits=c(-1.5, 1.5),expand = c(0, 0.2))

ggsave("reg_model_ultdrift_reduced_transformed.png", plot = last_plot(), device = "png", 
       path = "C:\\Users\\J\\Desktop\\Course_DataAnalysis\\Proposal\\Pictures",
...
ggsave("qq_model_ultdrift_reduced_transformed.png", plot = last_plot(), device = "png", 
       path = "C:\\Users\\J\\Desktop\\Course_DataAnalysis\\Proposal\\Pictures",
       scale = 1, width = 6, height = 6, units ="cm",
       dpi = 300)
...
model_ultdrift_full<- lm(log(T)~ E+G+H+I+J+K+M+log(Q),data=dataset_2)
summary(model_ultdrift_full)

sink("C:/Users/J/Desktop/Course_DataAnalysis/results/result_model_ultdrift_full_transformed.txt")
...
theme_linedraw()+
  ...
  scale_x_continuous(breaks=c(-1.2,-0.8,-0.4,0,0.4,0.8,1.2),limits=c(-1.2, 1.2),expand = c(0, 0.2))+
  scale_y_continuous(breaks=c(-1.2,-0.8,-0.4,0,0.4,0.8,1.2),limits=c(-1.2, 1.2),expand = c(0, 0.2))
  

ggsave("reg_model_ultdrift_full_transformed.png", plot = last_plot(), device = "png", 
       path = "C:\\Users\\J\\Desktop\\Course_DataAnalysis\\Proposal\\Pictures",
       scale = 1, width = 6, height = 6, units ="cm",
       dpi = 300)
...
ggsave("qq_model_ultdrift_full_transformed.png", plot = last_plot(), device = "png", 
       path = "C:\\Users\\J\\Desktop\\Course_DataAnalysis\\Proposal\\Pictures",
       scale = 1, width = 6, height = 6, units ="cm",
       dpi = 300)
...
model_ultdrift_full_stepwise<- lm(formula = T ~ E + Q + H + I+ J, data = dataset_2)
summary(model_ultdrift_full_stepwise)


plot(model_ultdrift_full_stepwise)
confint(model_ultdrift_full_stepwise,level=0.95)
...
ggplot(data=modeldata_ultdrift_full_final, aes(x=modeldata_ultdrift_full_final$fitted_values,y=modeldata_ultdrift_full_final$res)) + 
  ...
  geom_point(colour = "black", size = 1.5)+
  annotate("segment", x = -0.8, xend = -0.4, y = -2.8, yend = -2.8, colour = "blue", size=0.08, alpha=1, arrow=arrow(length = unit(0.1, "inches"),type="closed"))+
...
theme_linedraw()+
  ...
  theme(axis.text.x = element_text(family="Times New Roman",
        ...
        axis.title.x = element_text(family="Times New Roman", colour="black", size=9),
        axis.title.y = element_text(family="Times New Roman", colour="black", size=9))+
  scale_x_continuous(breaks=c(-1.0,-0.5,0,0.5,1.0,1.5),limits=c(-1.0, 1.5),expand = c(0, 0.2))+
  scale_y_continuous(breaks=seq(-3,3,1),limits=c(-3, 3),expand = c(0, 0.2))
...
ggsave("qq_model_ultdrift_full_final.png", plot = last_plot(), device = "png", 
       path = "C:\\Users\\J\\Desktop\\Course_DataAnalysis\\Proposal\\Pictures",
       scale = 1, width = 6, height = 6, units ="cm",
       dpi = 300)
